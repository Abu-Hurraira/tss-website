        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-12 lg:gap-6">
          {pillars.map((pillar, i) => (
            <Reveal
              ...
              className={
                i === 0
                  ? 'relative min-h-[260px] overflow-hidden rounded-[22px] lg:col-span-7 lg:min-h-[400px]'
                  : i === 1
                    ? 'relative min-h-[260px] overflow-hidden rounded-[22px] lg:col-span-5 lg:min-h-[400px]'
                    : 'relative min-h-[260px] overflow-hidden rounded-[22px] lg:col-span-6'
              }
            >
              <img
